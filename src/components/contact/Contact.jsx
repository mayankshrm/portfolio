...
const Contact = () => {
    ...
    const sendEmail = (e) => {
       ...
       emailjs.sendForm('service_w4tnqaq', 'template_1edg426', form.current, 'AkNtgB2prtafhLdML')
        e.target.reset();
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">mayankshrm101@gmail.com</span>
                        
                        <a href="mailto:mayankshrm101@gmail.com" className="contact__button">
                            Write Me{" "} 
